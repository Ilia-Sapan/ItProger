...
rot_rb = Radiobutton(fenster, text="Rot", variable=farbwahl, value="Red")
rot_rb.grid(row=1, column=0)

gruen_rb = Radiobutton(fenster, text="Grün", variable=farbwahl, value="Green")
gruen_rb.grid(row=1, column=1)

blau_rb = Radiobutton(fenster, text="Blau", variable=farbwahl, value="Blue")
